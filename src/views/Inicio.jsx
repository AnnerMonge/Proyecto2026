...
export default function Inicio() {
  ...
  const COLORES = ["#00e5ff", "#006b8f", "#00d9ff", "#00cfff", "#00ffff", "#002e4d"];
  ...
  return (
    <Container fluid className="mt-2">
      ...
      <Row className="g-4 mb-5">
        <Col md={6} lg={3}>
          <Card className="h-100 text-white shadow" style={{ background: "linear-gradient(135deg, #006b8f, #00d9ff)" }}>
            <Card.Body>
        ...
        <Col md={6} lg={3}>
          <Card className="h-100 text-white shadow" style={{ background: "linear-gradient(135deg, #002e4d, #00e5ff)" }}>
            <Card.Body>
              <h5>Efectivo</h5>
        ...
        <Col md={6} lg={3}>
          <Card className="h-100 text-white shadow" style={{ background: "linear-gradient(135deg, #00cfff, #00ffff)" }}>
            <Card.Body>
              <h5>Tarjeta</h5>
        ...
        <Col md={6} lg={3}>
          <Card className="h-100 text-white shadow" style={{ background: "linear-gradient(135deg, #00d9ff, #006b8f)" }}>
            <Card.Body>
            ...
            <Card.Body>
              ...
              <ResponsiveContainer width="100%" height={360}>
                <LineChart data={estadisticas.ventasPorHora}>
                  ...
                  <Line type="monotone" dataKey="total" stroke="#00e5ff" strokeWidth={4} dot={{ r: 6 }} />
                </LineChart>
              </ResponsiveContainer>
            </Card.Body>
          </Card>
